...
<div class="media-body">
<h5 class="notification-user">Nadhir Gh</h5>
...
<span>Nadhir Gh</span>
<span id="more-details">developeur de ce site <i class="ti-angle-down"></i></span>
</div>
</div>
...
<a href="index.php">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.ecommerce">gestion livraison</span>
<span class="pcoded-mcaret"></span>
</a>
</li>
<li class=" ">
...
<body>
<div class="container">
	<h1 class="page-header text-center">tableaux des livreurs</h1>
	<div class="row">
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>".$row['statut']."</td>
									<td>
										<a href='#edit_".$row['id_livreur']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Modifier  </a>
										<a href='#delete_".$row['id_livreur']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Supprimer</a>
									</td>
								</tr>";
