                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                ...
                                <div class="ht__pro__qun">
                                    <span>Showing 1-12 of <?php echo count($get_product); ?> products</span>
                                </div>
                                            ...
                                            <div class="category">
                                                <div class="ht__cat__thumb">
                                                    <a href="product-details.php?id=<?php echo $list['id_produit']?>">
                                                        <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['photo_produit']?>" alt="product images">
                                                    </a>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="ht__list__product">
                                                    <div class="ht__list__thumb">
                                                        <a href="product-details.html"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['photo_produit']?>" alt="product images"></a>
                                                    </div>
                                                    <div class="htc__list__details">
                                                        <h2><a href="product-details.html"><?php echo $list['nom_produit']?> </a></h2>
                                                        <ul  class="pro__prize">
                                                            <li class="old__prize">$<?php echo $list['prix_produit']?></li>
                                                            <li>$<?php echo $list['prix_produit']?></li>
                                                        </ul>
                                                        ...
                                                        <p><?php echo $list['description_produit']?></p>
