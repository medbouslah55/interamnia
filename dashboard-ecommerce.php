...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='delete'){
        ...
        $delete_sql_2="delete from `order_detail`where order_id='$id'";
		mysqli_query($con,$delete_sql_2);
	}
}
$sql="select * from client order by id desc";
$res=mysqli_query($con,$sql);
require('order-stat.php');
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <body>
                              ...
                              <div class="page-header">
                                 ...
                                 <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                       ...
                                       <li class="breadcrumb-item"><a href="#!">Ecommerce Dashboard</a></li>
                                    </ul>
                                 </div>
                              </div>
                              <div class="page-body">
                                 <div class="row">
                                    <div class="col-md-12 col-xl-4">
                                       <div class="card counter-card-1">
                                          <div class="card-block-big">
                                             <div>
                                                <h3><?php echo $prod_selled; ?> de <?php echo $all_prod; ?></h3>
                                                <p>Produits vendus
                                                   <span class="f-right text-primary">
                                                   <i class="icofont icofont-arrow-up"></i>
                                                   <?php echo number_format((float)$stat_1, 1, '.', ''); ?>%
                                                   </span>
                                                </p>
                                                <div class="progress ">
                                    ...
                                    <div class="card counter-card-2">
                                       <div class="card-block-big">
                                          <div>
                                             <h3><?php echo $client_order; ?> de <?php echo $all_client; ?></h3>
                                             <p>Clients a commandés
                                             <span class="f-right text-success">
                                                   <i class="icofont icofont-arrow-up"></i>
                                                   <?php echo number_format((float)$stat_2, 1, '.', ''); ?>%
                                                   </span>
                                             </p>
                                             <div class="progress ">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                       <div class="card counter-card-3">
                                          <div class="card-block-big">
                                             <div>
                                                <h3><?php echo $done_order; ?> de <?php echo $all_order; ?></h3>
                                                <p>Commandes terminée
                                                   <span class="f-right text-default">
                                                   <i class="icofont icofont-arrow-down"></i>
                                                   <?php echo number_format((float)$stat_3, 1, '.', ''); ?>%
                                                   </span>
                                                </p>
                                                <div class="progress ">
                                             ...
                                             <div class="table-responsive">
                                                <div class="dt-responsive table-responsive">
                                                   <table id="res-config" class="table table-bordered w-100">
                                                      ...
                                                      <tbody>
                                                      <?php 
                                                                $res=mysqli_query($con,"select `order`.*,order_status.name as order_status_str from `order`,order_status where order_status.id=`order`.order_status order by added_on desc limit 5");
                                                                while($row=mysqli_fetch_assoc($res)){
                                                            ?>
                                                         <tr>
                                                         <td><h6><?php echo $row['id']?></h6></td>
                                                            <td><h6><?php echo $row['added_on']?></h6></td>
                                                            <td><h6>$<?php echo $row['total_price']?></h6></td>
                                                            <td>
                                                                    <?php if($row['order_status_str']=='Complete' || $row['order_status_str']=='Shipped'){ ?>
                                                                        <label class="label label-success"><?php echo $row['order_status_str']?></label>
                                                                    <?php }else if($row['order_status_str']=='Pending' || $row['order_status_str']=='Processing'){ ?>
                                                                        <label class="label label-warning"><?php echo $row['order_status_str']?></label>
                                                                    <?php }else if($row['order_status_str']=='Canceled'){ ?>
                                                                        <label class="label label-danger"><?php echo $row['order_status_str']?></label>
                                                                    <?php } ?>
                                                               </td>
                                                               <td class="action-icon">
                                                                  <a href="order-details.php?id=<?php echo $row['id']?>" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                                                  <a href="?type=delete&id=<?php echo $row['id']?>" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                                               </td>
                                                         </tr>
                                                                    <?php } ?>
                                                      </tbody>
                           ...
                           <div class="page-wrapper">
                              <div class="page-body">
                                 <div class="row">
                                    ...
                                    <div class="card-block">
                                       <div class="dt-responsive table-responsive">
                                          <table id="dt-plugin-method" class="table table-striped dt-responsive nowrap">
										  <thead>
                                                            <tr>
                                                               <th>Order ID</th>
                                                               <th>Order Staus</th>
                                                         ...
                                                         <tbody>
                                                            <?php 
                                                                ...
                                                                $all_income=0;
                                                                while($row=mysqli_fetch_assoc($res)){
                                                                   $all_income=$all_income+$row['total_price'];
                                                            ?>
                                                            <tr>
                                                               <td><h6><?php echo $row['id']?></h6></td>
                                                               <td>
                                                               ...
                                                               <td><h6><?php echo $row['payment_type']?></h6></td>
                                                               <td>
                                                                    <?php if($row['payment_status']=='success'){ ?>
                                                                        <label class="label label-success"><?php echo $row['payment_status']?></label>
                                                                    <?php }else if($row['payment_status']=='pending'){ ?>
                                                                        <label class="label label-warning"><?php echo $row['payment_status']?></label>
                                                                    <?php }else if($row['payment_status']=='canceled'){ ?>
                                                                        <label class="label label-danger"><?php echo $row['payment_status']?></label>
                                                                    <?php } ?>
                                                               </td>
                                                               <td>
                                                                  <h6><?php echo $row['shipping_type']?></h6>
                                                                  <span>$<?php echo $row['shipping_fees']?></span>
                                                               </td>
                                                               <td><h6>$<?php echo $row['total_price']?></h6></td>
															                  <td><h6><?php echo $row['added_on']?></h6></td>
                                                               <td class="action-icon">
      ...
      <script type="text/javascript" src="assets/pages/chart/c3/c3-custom-chart.js"></script>
   </body>
