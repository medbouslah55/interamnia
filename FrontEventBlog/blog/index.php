	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				...
				<a  data-toggle="modal" class="btn btn-primary" onclick="goTo('./deleteall.php')"> Delete All</a>
				<a href="./pdf/genratepdf.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
				

				<script type="text/javascript">
					function myFun() {
					x=document.getElementById('rechercher').value;
					sql="SELECT * FROM client WHERE ville LIKE '%'"+x
					window.location.href='interm.php?sql='+sql;			 
}
				</script>
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										...
										<td>
										<a href='#affecter_".$row['id_article']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Affecter</a>
									</td>
								</tr>";
