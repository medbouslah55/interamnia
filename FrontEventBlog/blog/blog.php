...
<!-- Mirrored from flatable.phoenixcoded.net/default/wysiwyg-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 12:22:26 GMT -->
<head>
...
<a href="dashboard-crm.html">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.crm"></span>
<span class="pcoded-mcaret"></span>
</a>
</li>
<li class=" ">
<a href="dashboard-analytics.html">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.analytics"></span>
<span class="pcoded-badge label label-info ">NEW</span>
<span class="pcoded-mcaret"></span>
</a>
</li>
...
<a href="dashboard-project.html">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.project"></span>
<span class="pcoded-mcaret"></span>
</a>
</li>
</ul>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				...
				<a href="./delete_all.php" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Delete All</a>
				<a href="./pdf/genratepdf.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
					...
					<tbody>
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								 $chemin='upload/'.$row['image_article'] ;
								echo 
								"<tr>
									...
									<td><img src='$chemin' style='width:100px;height:150px;'/></td>
									<td>".$row['id_event']."</td>
									<td>
										<a href='#edit_".$row['id_article']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
										<a href='#delete_".$row['id_article']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</td>
								</tr>";
...
<!-- Mirrored from flatable.phoenixcoded.net/default/wysiwyg-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 12:22:29 GMT -->
</html>
