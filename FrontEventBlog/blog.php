...
<body>
    ...
    <div class="wrapper">
        ...
        include_once('connection.php');
                            $sql = "SELECT date_article,titre_article,description_article,image_article FROM blog";
                            ...
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                      <?php echo "<img src='$chemin' style='width:400px;height:287px;' />" ?>
                                    </a>
                                </div>
                                <div class="blog__details">
                                    <div class="bl__date">
                                        <span><?php echo $row['date_article']; ?></span>
                                    </div>
                                    <h2><a href="blog-details.html"><?php echo $row['titre_article']; ?></a><h>
                                    <div class="blog__btn">
