...
<span class="pcoded-mtext" data-i18n="nav.dash.default">gestion des livraisons</span>
<span class="pcoded-mcaret"></span>
</a>
</li>
<li class="">
<a href="">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.ecommerce">statistique</span>
<span class="pcoded-mcaret"></span>
</a>
</li>
...
<ul class="pcoded-submenu">
<li class="">
<a href="../livreur\index.php">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.default">Gestion des livreurs</span>
<span class="pcoded-mcaret"></span>
</a>
</li>
<li class=" ">
<a href="../livreur\statistique.php">
<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
<span class="pcoded-mtext" data-i18n="nav.dash.ecommerce">statistique</span>
<span class="pcoded-mcaret"></span>
</a>
...
<style>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
			<a href="add_modal.php" id="new"  class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nouveau</a>
...
<table id="basic-btn" class="table table-striped table-bordered nowrap">
	<thead>
				...
				<th >Action</th>
					...
					<?php
			      		include_once('connection.php');
							//$sql = "SELECT li.id_livraison,li.date_livraison,li.id_livreur,l.nom_livreur FROM livraison li inner join livreur l on li.id_livreur=l.id_livreur";
							//$sql = "SELECT * from livraison";
							$sql="SELECT * FROM livraison r INNER JOIN projet_web.order p ON (p.id=r.id_commande)";
							//use for MySQLi-OOP
							$query = $conn->query($sql);
							while($row = $query->fetch_assoc()){
								echo 
								"<tr>
									...
									<td>
									<a href='#edit_".$row['id_livraison']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
									<a href='#delete_".$row['id_livraison']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									<a href='#affecter_".$row['id_livraison']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Affecter</a>
									
									</td>
								</tr>";
								include('edit_delete_modal.php');
								include('affecter_modal.php');
