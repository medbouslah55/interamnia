...
<!-- Mirrored from flatable.phoenixcoded.net/default/form-picker.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 11:57:02 GMT -->
<head>
...
<center>   
		...
		<tr>
				<div class="row form-group">
					<div class="col-sm-2">
					<td>	<label class="control-label modal-label">date:</label></td>
					</div>
					<div class="col-sm-10">
						<td><input type="date" class="form-control" name="date_livraison" min="<?php echo date("Y-m-d") ?>"  required></td>
					</div>
				</div>
</tr>
				<tr>
				<div class="row form-group">
					<div class="col-sm-2">
						<td><label class="control-label modal-label">id :</label></td>
					</div>
					<div class="col-sm-10">
				...
				<?PHP
										  ...
										  session_start();
				$idd= $_SESSION["id"];
				$sql = "SELECT `id` FROM `order` where id!='$idd'";
				$listelivreurs = $conn->query($sql);
		...
		<option  value="<?php echo $row['id'] ?>"><?php echo $row['id'] ?></option>
				...
				<td><button type="submit" name="valider" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> voir plus</a></td>
...
<tr>
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<td><label class="control-label modal-label">adresse:</label></td>
					</div>
					<div class="col-sm-10">
					<td><input type="text" class="form-control" name="address" value="<?php echo $_SESSION["address"] ?>" readonly></td>
					</div>
				</div>
</tr>
<tr>
				<div class="row form-group">
					<div class="col-sm-2">
						<td><label class="control-label modal-label">city:</label></td>
					</div>
					<div class="col-sm-10">
					<td><input type="text" class="form-control" name="city" value="<?php echo $_SESSION["city"] ?>" readonly></td>
					</div>
				</div>
</tr>
		<tr>
			
						<td><label class="control-label modal-label">total_price:</label></td>
					
					
					<td><input type="number" class="form-control" name="total_price" value="<?php echo $_SESSION["total_price"] ?>" readonly></td>
					
</tr>
            
			 <tr>  <div class="modal-footer">
                <td><button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button></td>
				<td><button type="submit" name="add" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Save</a></td>
				</tr>
				</table>
			</form></center>
