                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="product-stock-stauts"><span class="nobr"> Shipping </span></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <span><?php echo $row['shipping_type']?></span>
                                                    <br>
                                                    <span>$<?php echo $row['shipping_fees']?></span>
                                                </td>
                                                <td class="product-name"><span>$<?php echo $row['total_price']?></span></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
