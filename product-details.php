                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="product-grid.php?id=<?php echo $get_product['0']['id_categorie'];?>"><?php echo $get_product['0']['nom_categorie']?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item active"><?php echo $get_product['0']['nom_produit'];?></span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['photo_produit']?>" alt="full-image">
                                        </div>
                                ...
                                <ul class="product__small__images" role="tablist">
                                    <li role="presentation" class="pot-small-img active">
                                        <a href="#img-tab-1" role="tab" data-toggle="tab">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['photo_produit']?>" alt="small-image">
                                        </a>
                                    </li>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                <h2><?php echo $get_product['0']['nom_produit']?></h2>
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize">$<?php echo $get_product['0']['prix_produit']?></li>
                                    <li>$<?php echo $get_product['0']['prix_produit']?></li>
                                </ul>
                                <p class="pro__info"><?php echo $get_product['0']['description_produit']?></p>
                                <div class="ht__pro__desc">
                                <?php if($get_product['0']['quantite_produit']>0){?>
                                    <div class="sin__desc">
                                    ...
                                    <div class="cr__btn">
                                    <a class="fr__btn" id="add__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id_produit']?>','add')">Add to cart</a>
                                        </div>
                                        <?php } else{ ?>
                                            <div class="sin__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li><a href="categorie.php?id=<?php echo $get_product['0']['id_categorie']?>"><?php echo $get_product['0']['nom_categorie']?></a></li>
                                        </ul>
                                    </div>
                                    <div class="sin__desc align--left">
